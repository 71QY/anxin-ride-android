...
项目简介：
安心出行是一款专注于家庭出行场景的智能打车 Android 应用，核心提供代叫车服务与亲情守护功能。支持子女远程为父母叫车、实时追踪行程状态，并专为老年群体打造适老化操作界面。项目采用 Jetpack Compose + MVVM 现代化技术栈，集成高德地图、WebSocket 实时通信、语音交互等能力，兼顾业务实用性与用户体验。安心出行是一款专注于家庭出行场景的智能打车 Android 应用，核心提供代叫车服务与亲情守护功能。支持子女远程为父母叫车、实时追踪行程状态，并专为老年群体打造适老化操作界面。项目采用 Jetpack Compose + MVVM 现代化技术栈，集成高德地图、WebSocket 实时通信、语音交互等能力，兼顾业务实用性与用户体验。
