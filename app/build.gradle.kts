...
android {
    ...
    defaultConfig {
        ...
        // 当前WiFi网络 (C) - 后端服务器IP:
        val apiBaseUrl = project.findProperty("api.baseUrl")?.toString() ?: "http://10.184.246.80:8080/api/"
        ...
        // 当前WiFi网络 (C) - 后端服务器IP:
        val websocketUrl = project.findProperty("websocket.url")?.toString() ?: "ws://10.184.246.80:8080/ws/agent"
